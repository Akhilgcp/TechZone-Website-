...
function CodeBlockLine({ index }: { index: number }) {
    const [style, setStyle] = useState<React.CSSProperties>({
        width: '60%',
        marginLeft: '0%',
        animation: `slideIn 2s ease-in-out infinite ${index * 0.2}s`,
        opacity: 0
    });
    ...
    return (
        <div
            className={cn(
                ...
                'from-primary/60 via-primary/80 to-primary/60 bg-gradient-to-r',
            )}
            style={style}
        />
    );
...
export default function CardFlip({
    ...
    const primaryHsl = hexToHsl(color ?? '#2563eb');
    ...
    return (
        <div
            ...
            className={cn("group relative w-full h-full [perspective:2000px]", className)}
        ...
        >
            ...
            >
                ...
                >
                    ...
                    {/* Bottom content - Added z-index to ensure visibility */}
