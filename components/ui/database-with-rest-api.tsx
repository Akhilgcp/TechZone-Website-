    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <path
                        ...
                        className={cn("transition-opacity duration-300", activeHighlights && !activeHighlights.includes(1) ? "opacity-20" : "opacity-100")}
                    />
                    <path
                        d="M 77 10 v 10 q 0 5 5 5 h 13 q 5 0 5 5 v 10"
                        className={cn("transition-opacity duration-300", activeHighlights && !activeHighlights.includes(2) ? "opacity-20" : "opacity-100")}
                    />
                    <path
                        d="M 124 10 v 10 q 0 5 -5 5 h -14 q -5 0 -5 5 v 10"
                        className={cn("transition-opacity duration-300", activeHighlights && !activeHighlights.includes(3) ? "opacity-20" : "opacity-100")}
                    />
                    <path
                        d="M 170 10 v 15 q 0 5 -5 5 h -60 q -5 0 -5 5 v 10"
                        className={cn("transition-opacity duration-300", activeHighlights && !activeHighlights.includes(4) ? "opacity-20" : "opacity-100")}
                    />
            ...
            <div className="absolute bottom-10 flex w-full flex-col items-center">
                ...
                {/* box outter circle */}
                <div className="absolute -bottom-8 z-30 flex h-[60px] min-w-[60px] px-4 items-center justify-center rounded-full border border-t bg-[#141516] font-semibold text-[10px] whitespace-nowrap">
